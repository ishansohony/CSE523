...
class Merge():
    ...
    def Merge_layout_task_LL(self, batch_images, task, train=True):
        ...
        # #
            ...
            self.up_map2 = ops._deconv_layer(self.concat_conv, self.mask_conv2.get_shape(), 128, 32, stride=2,
                                         name='Added_mask_upconv2')
            self.up_map4 = ops._deconv_layer(self.up_map2, self.mask_conv1.get_shape(), 32, 16, stride=2,
                                         name='Added_mask_upconv4')
            self.up_map8 = ops._deconv_layer(self.up_map4, self.mask.get_shape(), 16, 1, stride=2,
