...
import os
import time
from NETS import Task_driven_model
...
def test():
    with tf.Graph().as_default():
        # img_gt = misc.imread()
        batch_img = readtestdata(['/home/nodlehs/Datasettf/0.tfrecords'])
        ...
        Final_mergeNet.bulid_merge(batch_imgs, batch_labs, alpha = 0.5, train=False)
